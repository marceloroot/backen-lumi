...
import { ExtractDataFileUseCase } from '../../src/application/useCase/invoce/extract-data-file-use-case';
...
test("Deveria salvar no banco de dados os invoices e usuarios referente ao UseCase ", async function(){
    ...
    const extratdd =  new ExtractDataFileUseCase(useRepository,invoceRepository,extractService);
